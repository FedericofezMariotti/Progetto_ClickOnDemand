<x-layout>
    ...
    <div class="container-fluid category-bg justify-content-center align-items-center d-flex text-white " style="background-image: url(http://[::1]:5173{{ $subcategory->category->img }})">
        <div class="container">
            <div class="row category-bg">
                <div class="col-12 mt-3 text-center d-flex flex-column justify-content-center align-items-center">
                    <h1 class="uppercase">{{ $subcategory->name }}</h1>
                    <nav style=""
                        ...
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item uppercase active text-white" aria-current="page"><a href="{{ route('categoryArticle', ['category' => $subcategory->category]) }}">{{ $subcategory->category->name }}</a></li>
                            <li class="breadcrumb-item text-white"><span>></span></li>
                            <li class="breadcrumb-item uppercase active text-white" aria-current="page">{{ $subcategory->name }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
